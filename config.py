...
NUMERIC_MENU = {
    ...
    # Практика & курсы (14-23) - расширено
    ...
    "20": "story",  # Режим истории
    "21": "task",  # Задание
    "22": "genassignment",  # Генератор заданий
    "23": "adaptive",  # Адаптивные слабые темы
    # Управление (24-33)
    "24": "provider",  # Показать провайдера
    "25": "model",  # Показать модель
    "26": "terminal",  # Лог терминала
    "27": "cache stats",  # Статистика кэша
    "28": "clearcache",  # Очистить кэш
    "29": "check",  # Проверить контейнеры
    "30": "history",  # История чата
    "31": "writeup",  # Шаблон writeup
    "32": "add_book",  # Добавить книгу (интерактивно)
    "33": "social",  # Social engineering trainer
    # Разное (34-47)
    "34": "repeat",  # Интервальные повторения
    "35": "summary",  # Генерация конспекта
    "36": "auto_writeup",  # Автоматический writeup
    "37": "flag",  # Проверить флаг (нужен аргумент)
    "38": "log",  # Записать лог
    "39": "set-api-key",  # Установить API ключ
    "40": "smart_test",  # Умный тест (без URL)
    "41": "read_url",  # Чтение URL
    "42": "threats",  # Угрозы
    "43": "groups",  # Группы APT
    "44": "threat summary",  # Сводка угроз
    "45": "cve",  # CVE информация
    "46": "news search",  # Search
    "47": "sandbox",  # Песочница для кода
    "48": "hint",  # Подсказки в реальном времени
}
