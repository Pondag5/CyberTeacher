...
def handle_auto_writeup(action: str) -> Tuple[bool, Optional[Any], Optional[Any], bool]:
...
"""
            ...
            state.last_writeup_activity = activity  # оставляем для повторного использования
