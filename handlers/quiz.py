...
def handle_quiz_action() -> Tuple[bool, Optional[Any], Optional[Any], bool]:
    ...
    try:
        ...
        console.print(f"[bold green]📝 Квиз: {len(questions)} вопросов по теме '{quiz_topic}'[/bold green]")
...
def handle_task_action() -> Tuple[bool, Optional[Any], Optional[Any], bool]:
    ...
    try:
        ...
        console.print("[yellow]Ведите ваш ответ или команду. /skip - пропустить, /exit - выйти[/yellow]\n")
