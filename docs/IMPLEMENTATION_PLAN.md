...
| H-17 | Сканирование уязвимостей зависимостей | Запуск pip-audit/safety в CI, блокировать merge при критических уязвимостях. | — | Not started |
| H-18 | Метрики производительности | Логирование времени ответа, токенов, hit rate кэша. Дашборд в /stats. | — | Not started |
...
| M-33 | ADRs (Architecture Decision Records) | Документирование ключевых архитектурных решений в docs/adr/. | — | Not started |
