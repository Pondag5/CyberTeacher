...
class TestHealthHandler(unittest.TestCase):
    ...
    @patch("handlers.health.get_state")
    @patch("handlers.health.console")
    def test_health_returns_success(self, mock_console, mock_get_state):
    ...
    @patch("handlers.health.get_state")
    @patch("handlers.health.console")
    def test_health_zero_cache_division(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_state.start_time = 0
    ...
    @patch("handlers.health.get_state")
    @patch("handlers.health.console")
    def test_health_uptime_calculation(self, mock_console, mock_get_state):
        import time
        mock_state = MagicMock()
