...
class TestCTFFlags(unittest.TestCase):
    ...
    @patch("handlers.ctf_flags.get_state")
    @patch("handlers.ctf_flags.console")
    def test_handle_ctf_flags_list(self, mock_console, mock_get_state):
    ...
    @patch("handlers.ctf_flags.get_state")
    @patch("handlers.ctf_flags.console")
    def test_handle_ctf_flags_generate(self, mock_console, mock_get_state):
        mock_state = MagicMock()
    ...
    @patch("handlers.ctf_flags.get_state")
    @patch("handlers.ctf_flags.console")
    def test_handle_ctf_flags_submit_invalid_format(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_get_state.return_value = mock_state
    ...
    @patch("handlers.ctf_flags.get_state")
    @patch("handlers.ctf_flags.console")
    def test_handle_ctf_flags_verify(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_get_state.return_value = mock_state
