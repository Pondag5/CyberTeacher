...
class TestEmotionsHandler(unittest.TestCase):
    ...
    @patch("handlers.emotions.get_state")
    @patch("handlers.emotions.console")
    def test_emotions_no_args(self, mock_console, mock_get_state):
    ...
    @patch("handlers.emotions.get_state")
    @patch("handlers.emotions.console")
    def test_emotions_auto(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_get_state.return_value = mock_state
    ...
    @patch("handlers.emotions.get_state")
    @patch("handlers.emotions.console")
    def test_emotions_set_happy(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_get_state.return_value = mock_state
    ...
    @patch("handlers.emotions.get_state")
    @patch("handlers.emotions.console")
    def test_emotions_set_invalid(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_get_state.return_value = mock_state
    ...
    @patch("handlers.emotions.get_state")
    @patch("handlers.emotions.console")
    def test_emotions_show(self, mock_console, mock_get_state):
        mock_state = MagicMock()
        mock_state.emotion_mode = "neutral"
        mock_get_state.return_value = mock_state
    ...
    @patch("handlers.emotions.get_state")
    def test_get_emotion_status(self, mock_get_state):
        mock_state = MagicMock()
    ...
    @patch("handlers.emotions.get_state")
    def test_get_emotion_prompt_modifier_auto(self, mock_get_state):
        mock_state = MagicMock()
